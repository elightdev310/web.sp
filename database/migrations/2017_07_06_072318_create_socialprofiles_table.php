...
class CreateSocialprofilesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Socialprofiles", 'socialprofiles', 'email', 'fa-cube', [
            ["provider", "Provider", "String", false, "", 0, 20, false],
            ["provider_id", "Provider ID", "String", false, "0", 0, 50, false],
            ["email", "Email", "Email", false, "", 0, 250, false],
            ["token", "Token", "String", false, "", 0, 200, false],
        ]);
    ...
    {
        if (Schema::hasTable('socialprofiles')) {
